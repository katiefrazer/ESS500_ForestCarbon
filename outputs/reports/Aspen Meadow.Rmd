...
aspen_freq_tidy %>%
  ...
  geom_col(aes(fill = Cover_Type)) +
  labs(title = "Aspen Meadow Ground Cover Frequency from 1996-2004 and 2024",
       subtitle = "Data Collected at CSU Mountain Campus",
       x = "Year",
...
# they both convey the same information, just in different ways
```
...
phasePortrait(aspen_freq_tidy, ylim = 0)
```
