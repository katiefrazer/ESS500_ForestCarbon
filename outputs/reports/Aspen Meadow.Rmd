...
aspen_freq_tidy %>%
  ...
  geom_col(aes(fill = Cover_Type))
  labs(title = "Aspen Meadow Ground Cover Frequency from 1996-2004",
       subtitle = "Data Collected at CSU Mountain Campus",
       x = "Year",
       y = "Percentage of Quadrats")

# may need to adjust so that we can more easily compare by cover type
# x be year and y be percentage, facet wrap by cover type?
```
...
aspen_avg_cover <- read_excel("../../data/clean/aspen_meadow.xlsx", 
